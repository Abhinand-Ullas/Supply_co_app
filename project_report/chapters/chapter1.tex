...
\begin{enumerate}[label=\textbf{Step \arabic*:}]
    ...
    \item \textbf{Edge Function Development:} Developed two Supabase Edge Functions: \texttt{sync-stock} for periodic data synchronization and \texttt{send-push} for webhook-triggered push notifications.
